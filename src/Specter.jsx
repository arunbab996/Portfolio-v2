...
export default function Specter() {
  ...
  return (
    <div className="case-study-quarantine">
      <div className="specter-wrapper">
        <div className="container">
          ...
          <section className="animate-entry delay-4">
            ...
            <p>Once we realized the realized the earliest signals exist at the founder level, we changed how we measured success. Initially, we tracked new companies surfaced per week — but that signal was too late and too noisy.</p>
